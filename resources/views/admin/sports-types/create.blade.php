...
@section('title', 'Add Sport Type')

@section('content')
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-white rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">Add New Sport Type</h1>
        
        <form action="{{ route('admin.sports-types.store') }}" method="POST">
            @csrf
